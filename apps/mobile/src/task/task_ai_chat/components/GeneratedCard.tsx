  ...
  return (
    <Box className="mb-6 w-full flex-row justify-start">
      <Box
        ...
        className="w-[150px] rounded-[24px] border border-outline-variant bg-surface-container-highest px-4 pb-4 pt-6"
      >
        <Text className="mb-10 text-sm leading-5 text-on-surface">{message}</Text>
